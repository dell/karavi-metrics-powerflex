...
//
//	mockgen -destination=mocks/statistics_getter_mocks.go -package=mocks github.com/dell/karavi-metrics-powerflex/internal/service StatisticsGetter
//
...
func (m *MockStatisticsGetter) GetVolumeMetrics() ([]*v1.SdcVolumeMetrics, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetVolumeMetrics")
	ret0, _ := ret[0].([]*v1.SdcVolumeMetrics)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
