...
//go:generate mockgen -destination=mocks/leader_elector_getter_mocks.go -package=mocks github.com/dell/karavi-powerflex-metrics/internal/k8s LeaderElectorGetter
