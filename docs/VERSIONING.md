...
This versioning strategy applies to Dell Karavi PowerFlex Metrics.
...
### References
Dell Karavi PowerFlex Metrics follow Semantic Versioning as defined on [http://semver.org/](http://semver.org).